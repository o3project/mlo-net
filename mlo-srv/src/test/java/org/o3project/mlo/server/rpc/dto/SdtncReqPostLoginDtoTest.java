...
/**
 * SdtncReqPostLoginDtoTest
 *
 */
public class SdtncReqPostLoginDtoTest {
    ...
    public void testCreateInstance_001() {
        ...
        SdtncReqPostLoginDto obj = new SdtncReqPostLoginDto();
        obj.login = logIn;
        ...
        SdtncReqPostLoginDto request_unmarshaled = JAXB.unmarshal(istream, SdtncReqPostLoginDto.class);
    ...
    public void testSerializeToXml_req_req() throws Throwable {
        ...
        assertTrue(SdtncTestUtil.isSameXmlAs(serdes, reqDto, DATA_PATH, "sdtnc.post.login.req.xml"));
    }
